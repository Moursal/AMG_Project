_cqa_text_report = {
  paths = {
    {
      ...
      expert = {
        {
          title = "ASM code",
          txt = "In the binary file, the address of the loop is: 5a5c5\n\nInstruction                                        | Nb FU | P0   | P1   | P2   | P3   | P4 | P5   | P6   | P7   | Latency | Recip. throughput\n----------------------------------------------------------------------------------------------------------------------------------------------\nMOVSD (%R12,%RAX,8),%XMM1                          | 1     | 0    | 0    | 0.50 | 0.50 | 0  | 0    | 0    | 0    | 0       | 0.50\nUCOMISD %XMM2,%XMM1                                | 1     | 0    | 1    | 0    | 0    | 0  | 0    | 0    | 0    | 2       | 1\nJAE 5a5b0 <hypre_BoomerAMGCreateS._omp_fn.1+0x410> | 1     | 0.50 | 0    | 0    | 0    | 0  | 0    | 0.50 | 0    | 0       | 0.50-1\nMOV (%R14,%RAX,8),%RSI                             | 1     | 0    | 0    | 0.50 | 0.50 | 0  | 0    | 0    | 0    | 2       | 0.50\nMOV %RSI,(%R8,%RAX,8)                              | 1     | 0    | 0    | 0.33 | 0.33 | 1  | 0    | 0    | 0.33 | 3       | 1\nADD $0x1,%RAX                                      | 1     | 0.25 | 0.25 | 0    | 0    | 0  | 0.25 | 0.25 | 0    | 1       | 0.25\nCMP %RAX,(%RDX)                                    | 1     | 0.25 | 0.25 | 0.50 | 0.50 | 0  | 0.25 | 0.25 | 0    | 1       | 0.50\nJG 5a5c5 <hypre_BoomerAMGCreateS._omp_fn.1+0x425>  | 1     | 0.50 | 0    | 0    | 0    | 0  | 0    | 0.50 | 0    | 0       | 0.50-1\n",
        },
        {
    ...
    },
    {
      ...
      expert = {
        {
          title = "ASM code",
          txt = "In the binary file, the address of the loop is: 5a5c5\n\nInstruction                                        | Nb FU | P0   | P1   | P2   | P3   | P4 | P5   | P6   | P7   | Latency | Recip. throughput\n----------------------------------------------------------------------------------------------------------------------------------------------\nMOVQ $-0x1,(%R8,%RAX,8)                            | 1     | 0    | 0    | 0.33 | 0.33 | 1  | 0    | 0    | 0.33 | 3       | 1\nSUB $0x1,%RDI                                      | 1     | 0.25 | 0.25 | 0    | 0    | 0  | 0.25 | 0.25 | 0    | 1       | 0.25\nADD $0x1,%RAX                                      | 1     | 0.25 | 0.25 | 0    | 0    | 0  | 0.25 | 0.25 | 0    | 1       | 0.25\nCMP %RAX,(%RDX)                                    | 1     | 0.25 | 0.25 | 0.50 | 0.50 | 0  | 0.25 | 0.25 | 0    | 1       | 0.50\nJLE 5a5e2 <hypre_BoomerAMGCreateS._omp_fn.1+0x442> | 1     | 0.50 | 0    | 0    | 0    | 0  | 0    | 0.50 | 0    | 0       | 0.50-1\nMOVSD (%R12,%RAX,8),%XMM1                          | 1     | 0    | 0    | 0.50 | 0.50 | 0  | 0    | 0    | 0    | 0       | 0.50\nUCOMISD %XMM2,%XMM1                                | 1     | 0    | 1    | 0    | 0    | 0  | 0    | 0    | 0    | 2       | 1\nJAE 5a5b0 <hypre_BoomerAMGCreateS._omp_fn.1+0x410> | 1     | 0.50 | 0    | 0    | 0    | 0  | 0    | 0.50 | 0    | 0       | 0.50-1\n",
        },
        {
          title = "General properties",
        ...
        {
          title = "Back-end",
          txt = "       | P0   | P1   | P2   | P3   | P4   | P5   | P6   | P7\n--------------------------------------------------------------\nuops   | 1.50 | 1.50 | 1.00 | 1.00 | 1.00 | 1.50 | 1.50 | 1.00\ncycles | 1.50 | 1.50 | 1.00 | 1.00 | 1.00 | 1.50 | 1.50 | 1.00\n\nCycles executing div or sqrt instructions: NA\nLongest recurrence chain latency (RecMII): 1.00\n",
        },
        {
          title = "Cycles summary",
          txt = "Front-end : 2.00\nDispatch  : 1.50\nData deps.: 1.00\nOverall L1: 2.00\n",
  ...
  AVG = {
      ...
      expert = {
        ...
        {
          title = "Back-end",
          txt = "       | P0   | P1   | P2   | P3   | P4   | P5   | P6   | P7\n--------------------------------------------------------------\nuops   | 1.25 | 1.25 | 1.25 | 1.25 | 1.00 | 1.25 | 1.25 | 1.00\ncycles | 1.25 | 1.25 | 1.25 | 1.25 | 1.00 | 1.25 | 1.25 | 1.00\n\nCycles executing div or sqrt instructions: NA\nLongest recurrence chain latency (RecMII): 1.00\n",
        },
        {
          title = "Cycles summary",
          txt = "Front-end : 1.88\nDispatch  : 1.50\nData deps.: 1.00\nOverall L1: 1.88\n",
        ...
        {
          title = "Cycles and memory resources usage",
          txt = "Assuming all data fit into the L1 cache, each iteration of the binary loop takes 1.88 cycles. At this rate:\n - 16% of peak load performance is reached (10.86 out of 64.00 bytes loaded per cycle (GB/s @ 1GHz))\n - 13% of peak store performance is reached (4.29 out of 32.00 bytes stored per cycle (GB/s @ 1GHz))\n",
        },
      },
      header = {
        "0% of peak computational performance is used (0.00 out of 16.00 FLOP per cycle (GFLOPS @ 1GHz))",
